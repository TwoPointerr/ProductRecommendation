...
def show_all_products(request):
    ...
    page_number = request.GET.get('page')
    product_list = paginator.get_page(page_number)
    return render(request, "shop-grid-ls.html", {'product_list': product_list, 'all_category': all_category,'sub_category':subCategory_list,'article_type':all_articel_type_list})
